...
namespace Amax.Editor
{
    ...
    [CustomPropertyDrawer(typeof (StringParameterDictionary))]
    public class PropertyDrawerStringToStringParameterDictionary: PropertyDrawer
    {
		...
		public override void OnGUI (Rect rect, SerializedProperty property, GUIContent label) {
			...
			for (var i = 0; i < keys.arraySize; i++) 
			{
                ...
                // Text
                value.stringValue = EditorGUI.TextArea(new Rect(x - 10, y, fieldWidth, RowHeight), value.stringValue);
